...
export default function Menu({ className, variant, mini }) {
    ...
    return (
        <>
            ...
            <div id="my123" className={cn("w-full flex justify-center items-center gap-32 text-[#74645a]", variant === "hero" && !mini && "text-white pt-10", mini && "!text-[#74645a]", className)}>
                ...
                {/* mobile */}
                <div className={cn("fixed z-40 top-0 w-full bg-[#ece3d9] h-20 hidden lg:block mobNav", variant === "hero" && "absolute")}></div>
                <div className={cn("fixed z-50 top-0 w-full justify-around text-orange-950/60 font-black h-20 items-center gap-3 hidden lg:flex mobNav", variant === "hero" && "absolute")}>
